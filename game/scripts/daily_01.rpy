...
label daily_01:
    ...
    # ===== 进入练习室 =====
    # TODO: 背景建议替换为 bg 桌椅1 / bg 桌椅2 / bg 桌椅3（练习室内部）
    ...
    # 美步子重新出现：pos1
    # hide mhk 先清除 pos1 上的美步子，再在 pos1 重新显示（确保格子干净）
    hide mhk with dissolve
    show mhk normal at pos1
    with dissolve
    ...
    # 神奈：冷淡、审视
    # TODO: 表情差分 kanna_1/2/3 已移除，建议重新添加后此处替换为 kanna_1
    kanna "……"
    kanna "哦，新人。"
    ...
    # 神奈出场：pos1，替换友歌，冷言反驳
    # TODO: 建议使用 kanna_2（不悦/皱眉），当前表情差分已移除
    hide yuka with dissolve
    show kanna normal at pos1
    with dissolve
    ...
    # 神奈出场：pos3（居中偏右），准备退场
    # TODO: 建议使用 kanna_3（不耐烦/累了），当前表情差分已移除
    show kanna normal at pos3
    with dissolve
