...
label turn_talk:
    ...
    if debug:
        "（家里或者路上的场景）"
    "从那以后，大家练习越来越敷衍，甚至有些人开始缺席。"
    "给玲打电话，想要挽回她的心情，但她都没有接听。"
    "时间就这样一天天流逝着。"
    if debug:
        "（手机震动）"
    mhk "啊——玲！"
    "我匆忙跑去拿起手机接通电话。"
    yuka "美步子，今晚有空吗？大家想一起谈谈。"
    "像这样的电话我已经接了很多次了，但每次都不是玲。"
    "自从玲离开后，友歌好像一直想让乐队重回玲来以前的状态。"
