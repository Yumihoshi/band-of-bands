...
label turn_roadshow:
    ...
    # 转移注意力，切入正题
    "我指向广场中央。那里搭着一个临时的路演舞台，上面放着几把吉他、一台架子鼓，还有一把孤零零的贝斯。"
    ...
    if debug:
        "（激昂的音乐起）"
    "没有预先定好的曲目，也没有完美的配合。神奈随手弹了一段失真riff，友歌紧随其后加入了清亮的键盘音。"
    "我凭着直觉猛砸架子鼓，完全把什么节拍器抛在了脑后。"
    "乱七八糟的！"
    "但也……超级痛快！"
    ...
    rei "真是……被你们打败了。"
    rei "弹得简直一塌糊涂，神奈你进早了两拍，美步子你的鼓全靠力气大是吧？"
