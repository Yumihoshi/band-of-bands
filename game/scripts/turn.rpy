...
label turn_boom:
    ...
    show mhk excited at pos_center
    # 塑造元气笨蛋 & 社交依赖
    mhk "啊——又一天结束了，排练的日子可真辛苦啊。"
    mhk "终于可以好好休息了，嘿嘿~"
    hide mhk with dissolve
    show mhk action_01 at pos_center with dissolve
    mhk "软乎乎的被窝，我来啦~"
    hide mhk with dissolve
    show mhk excited at pos_center with dissolve
    ...
    rei "稍微…多用点心啊。"
    hide mhk with dissolve
    show mhk upset at pos_center with dissolve
    mhk "呜…知道了啦。"
    ...
    # 大家到齐，开始练习
    play sound sfx_door
    show yuka smile at pos1 with dissolve
    show kanna normal at pos4 with dissolve
    show akr shy at pos2 with dissolve
    show mhk normal at pos_center with dissolve
    ...
    show kanna hostile at pos4 with dissolve
    ...
    show rei upset at pos3 with dissolve
    ...
    hide mhk with dissolve
    show mhk shocked at pos_center with dissolve
    "只要伸出手。\n"
    extend "就能把乐队重新团结起来。"
    "还差一点，就能抓住玲的手。\n"
    extend "就能给乐队带来改变。"
...
label turn_talk:
    ...
    hide rei with dissolve
    show rei idle at pos3 with dissolve
    hide mhk with dissolve
    show mhk smile at pos2 with dissolve
    play music bgm_hope
...
label turn_roadshow:
    ...
    show akr timid at stage_left
    show mhk excited at stage_center
    show rei idle at stage_right
    ...
    "但也……超级痛快！"
    hide mhk with dissolve
    show mhk foolish_laugh at stage_center with dissolve
    ...
    akr "下次……我们再一起弹吧。"
    hide mhk with dissolve
    show mhk smile at stage_center with dissolve
    hide yuka with dissolve
    show yuka smile at stage_leftmost with dissolve
    hide akr with dissolve
    show akr smile at stage_left with dissolve
    play music bgm_hope
    ...
    hide mhk with dissolve
    show mhk upset at stage_center with dissolve
    mhk "诶——？！刚和好就要特训？救命啊——"
    hide mhk with dissolve
    show mhk smile at stage_center with dissolve
